...
//grantpermission 작동안해서  아래  로그로 일일이 확인해봄
//        Log.v("checking_current", String.valueOf(targetState));
//        Log.v("checking_current", String.valueOf(mEnabled));
//        Log.v("checking_current", String.valueOf(mCameraPermissionGranted));
//
//        Log.v("checking_current", String.valueOf(mSurfaceExist));
//        Log.v("checking_current", String.valueOf(getVisibility()));
